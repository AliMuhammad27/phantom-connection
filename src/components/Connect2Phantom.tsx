...
const Connect2Phantom: FC = () => {
    ...
    return (
        <div>
            { walletAvail ?
                <>
                <button className="main" disabled={connected} onClick={connectHandler}>Connect to Phantom</button>
                <button className="main" disabled={!connected} onClick={disconnectHandler} style={{marginLeft:"12px"}} >Disconnect from Phantom</button>
